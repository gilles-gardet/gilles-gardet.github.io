...
/* harmony import */ var primeng_scrolltop__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! primeng/scrolltop */ 1640);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/common */ 912);
...
/* harmony import */ var primeng_progressspinner__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/progressspinner */ 8132);
/* harmony import */ var primeng_blockui__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! primeng/blockui */ 4568);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ 7420);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ 1362);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs/operators */ 1480);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ 7714);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ 2890);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rxjs */ 191);
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
    ...
    template: function AppComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](1, 2, ctx.isLoading$))("ngIfElse", _r2);
      }
    },
    ...
    styles: [".p-card-title,\n.p-card-subtitle {\n  text-align: center;\n}\n\n.p-progressbar {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(210 14% 89% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) .p-progressbar) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(210 9% 31% / var(--tw-bg-opacity)) !important;\n}\n\n.p-progressbar {\n  height: 0.5rem;\n  border-radius: 5px;\n}\n.p-progressbar .p-progressbar-value {\n  --tw-bg-opacity: 1;\n  background-color: hsl(210 9% 31% / var(--tw-bg-opacity));\n}\n:is(:where(.dark) .p-progressbar .p-progressbar-value) {\n  --tw-bg-opacity: 1;\n  background-color: hsl(210 14% 89% / var(--tw-bg-opacity));\n}\n\n.p-tag {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(210 9% 31% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) .p-tag) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(210 14% 89% / var(--tw-bg-opacity)) !important;\n}\n\n.p-tag {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n\n:is(:where(.dark) .p-tag) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n\np-scrolltop > button.p-scrolltop {\n  z-index: 1004;\n}\n\np-panel .p-panel-header {\n  display: grid;\n  justify-content: center;\n}\np-panel .p-panel-header,\np-panel .p-panel-content {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(210 17% 98% / var(--tw-bg-opacity)) !important;\n}\n:is(:where(.dark) p-panel .p-panel-header),:is(:where(.dark) \np-panel .p-panel-content) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(217 17% 20% / var(--tw-bg-opacity)) !important;\n}\np-panel .p-panel-header,\np-panel .p-panel-content {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) p-panel .p-panel-header),:is(:where(.dark) \np-panel .p-panel-content) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\np-panel .p-panel-header,\np-panel .p-panel-content {\n  --tw-border-opacity: 1 !important;\n  border-color: hsl(210 14% 89% / var(--tw-border-opacity)) !important;\n}\n:is(:where(.dark) p-panel .p-panel-header),:is(:where(.dark) \np-panel .p-panel-content) {\n  --tw-border-opacity: 1 !important;\n  border-color: hsl(213 19% 30% / var(--tw-border-opacity)) !important;\n}\n\np-card > div.p-card {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(0 0% 100% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) p-card > div.p-card) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(217 17% 20% / var(--tw-bg-opacity)) !important;\n}\n\np-card > div.p-card {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n\n:is(:where(.dark) p-card > div.p-card) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n\np-card > div.p-card {\n  position: sticky;\n  top: 2rem;\n}\n\n.p-menu.p-menu-overlay {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(0 0% 100% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) .p-menu.p-menu-overlay) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(217 17% 20% / var(--tw-bg-opacity)) !important;\n}\n.p-menu .p-submenu-header {\n  display: flex;\n  justify-content: center;\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(0 0% 100% / var(--tw-bg-opacity)) !important;\n}\n:is(:where(.dark) .p-menu .p-submenu-header) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(217 17% 20% / var(--tw-bg-opacity)) !important;\n}\n.p-menu .p-menuitem-link .p-menuitem-text,\n.p-menu .p-submenu-header {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) .p-menu .p-menuitem-link .p-menuitem-text),:is(:where(.dark) \n.p-menu .p-submenu-header) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n.p-menu .p-menuitem-icon {\n  transition: color 0s, background-color 0s;\n}\n.p-menu .p-menuitem-link:not(.p-disabled):hover {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(214 16% 93% / var(--tw-bg-opacity)) !important;\n}\n:is(:where(.dark) .p-menu .p-menuitem-link:not(.p-disabled):hover) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(215 15% 23% / var(--tw-bg-opacity)) !important;\n}\n.p-menu .p-menuitem-link:not(.p-disabled):hover .p-menuitem-text,\n.p-menu .p-menuitem-link:not(.p-disabled):hover .p-menuitem-icon {\n  transition: color 0s, background-color 0s;\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) .p-menu .p-menuitem-link:not(.p-disabled):hover .p-menuitem-text),:is(:where(.dark) \n.p-menu .p-menuitem-link:not(.p-disabled):hover .p-menuitem-icon) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n\nbutton.p-button {\n  border: 1px solid var(--button);\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n\n:is(:where(.dark) button.p-button) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(212 10% 70% / var(--tw-text-opacity)) !important;\n}\nbutton.p-button.p-button.p-button-text, button.p-button.p-button.p-button-text:enabled:hover, button.p-button.p-button.p-button-text:enabled:active {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) button.p-button.p-button.p-button-text),:is(:where(.dark)  button.p-button.p-button.p-button-text:enabled:hover),:is(:where(.dark)  button.p-button.p-button.p-button-text:enabled:active) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(212 10% 70% / var(--tw-text-opacity)) !important;\n}\nbutton.p-button.p-button.p-button-text:enabled:hover, button.p-button.p-button.p-button-text:enabled:active {\n  background: rgba(75, 85, 94, 0.04);\n}\nbutton.p-button.p-button:focus, button.p-button.p-button.p-button-text:enabled:active {\n  box-shadow: 0 0 0 0.2rem #aab1b9;\n}\n\np-chip[label=\"gilles.gardet@gmail.com\"] {\n  --params: 0.8s ease;\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip {\n  position: relative;\n  overflow: hidden;\n  transition: color var(--params), background-color var(--params);\n  z-index: 0;\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(207 9% 31% / var(--tw-bg-opacity)) !important;\n}\n:is(:where(.dark) p-chip[label=\"gilles.gardet@gmail.com\"] .p-chip) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(216 14% 89% / var(--tw-bg-opacity)) !important;\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) p-chip[label=\"gilles.gardet@gmail.com\"] .p-chip) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip::before {\n  content: \"\";\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: -1;\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(216 14% 89% / var(--tw-bg-opacity)) !important;\n}\n:is(:where(.dark) p-chip[label=\"gilles.gardet@gmail.com\"] .p-chip)::before {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(207 9% 31% / var(--tw-bg-opacity)) !important;\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip::before {\n  transform: translateX(100%);\n  transition: transform var(--params), opacity var(--params);\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip:hover {\n  cursor: pointer;\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) p-chip[label=\"gilles.gardet@gmail.com\"] .p-chip:hover) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip:hover {\n  background-color: transparent;\n}\np-chip[label=\"gilles.gardet@gmail.com\"] .p-chip:hover::before {\n  transform: translateX(0);\n  opacity: 1;\n}\n\n.p-timeline-event-content,\n.p-timeline-event-opposite {\n  line-height: 1;\n}\n\n.p-button.p-button-secondary.p-button-outlined {\n  color: var(--dark);\n}\n\n.mission {\n  box-shadow: none;\n}\n.mission__animation-left {\n  opacity: 0;\n  transform: translateX(-40px);\n  animation: fadeIn 3s forwards;\n  -webkit-animation: fadeIn 3s forwards;\n  -moz-animation: fadeIn 3s forwards;\n  -o-animation: fadeIn 3s forwards;\n  -ms-animation: fadeIn 3s forwards;\n}\n.mission__animation-right {\n  opacity: 0;\n  transform: translateX(40px);\n  animation: fadeIn 3s forwards;\n  -webkit-animation: fadeIn 3s forwards;\n  -moz-animation: fadeIn 3s forwards;\n  -o-animation: fadeIn 3s forwards;\n  -ms-animation: fadeIn 3s forwards;\n}\n.mission__button {\n  display: flex;\n  justify-content: center;\n}\n\n.p-timeline-event-content > p-card > .mission > .p-card-body > .p-card-content {\n  text-align: left;\n}\n\n.p-timeline .p-timeline-event-connector {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(216 14% 89% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) .p-timeline .p-timeline-event-connector) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(213 19% 30% / var(--tw-bg-opacity)) !important;\n}\n\n.p-card-content {\n  display: grid;\n  gap: 1rem;\n}\n\n.p-dialog .p-dialog-header,\n.p-dialog .p-dialog-content {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(0 0% 100% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) .p-dialog .p-dialog-header),:is(:where(.dark) \n.p-dialog .p-dialog-content) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(217 17% 20% / var(--tw-bg-opacity)) !important;\n}\n\n.p-dialog .p-dialog-header,\n.p-dialog .p-dialog-content {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n\n:is(:where(.dark) .p-dialog .p-dialog-header),:is(:where(.dark) \n.p-dialog .p-dialog-content) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n.p-dialog .p-dialog-header {\n  display: grid;\n}\n.p-dialog .p-dialog-header .p-dialog-header-icons {\n  grid-area: 1/3/1/4;\n  align-self: flex-start;\n}\n.p-dialog .p-dialog-content {\n  border-bottom-right-radius: 3px;\n  border-bottom-left-radius: 3px;\n  display: flex;\n  justify-content: center;\n  overflow-x: hidden;\n  overflow-y: hidden;\n}\n.p-dialog .p-dialog-content .p-progress-spinner-circle {\n  animation: progress-spinner-dash 1.5s ease-in-out infinite, progress-spinner-color 6s ease-in-out infinite;\n}\n@keyframes progress-spinner-color {\n  100%, 0%, 40%, 66%, 80%, 90% {\n    stroke: hsl(210, 9%, 31%) !important;\n  }\n  :is(:where(.dark) 100%),:is(:where(.dark)  0%),:is(:where(.dark)  40%),:is(:where(.dark)  66%),:is(:where(.dark)  80%),:is(:where(.dark)  90%) {\n    stroke: hsl(240, 4%, 90%) !important;\n  }\n}\n@keyframes progress-spinner-dash {\n  0% {\n    stroke-dasharray: 1, 200;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 89, 200;\n    stroke-dashoffset: -35px;\n  }\n  100% {\n    stroke-dasharray: 89, 200;\n    stroke-dashoffset: -124px;\n  }\n}\n.p-dialog .p-dialog-content-scroll {\n  overflow-y: auto;\n  animation: hideScroll 800ms backwards;\n}\n\n.p-scrolltop.p-link {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(0 0% 30% / var(--tw-bg-opacity)) !important;\n}\n\n:is(:where(.dark) .p-scrolltop.p-link) {\n  --tw-bg-opacity: 1 !important;\n  background-color: hsl(210 14% 89% / var(--tw-bg-opacity)) !important;\n}\n.p-scrolltop .p-scrolltop-icon {\n  --tw-text-opacity: 1 !important;\n  color: hsl(240 4% 90% / var(--tw-text-opacity)) !important;\n}\n:is(:where(.dark) .p-scrolltop .p-scrolltop-icon) {\n  --tw-text-opacity: 1 !important;\n  color: hsl(210 9% 31% / var(--tw-text-opacity)) !important;\n}\n\n.p-link:focus {\n  box-shadow: 0 0 0 0.2rem #aab1b9;\n}\n\n@keyframes hideScroll {\n  from, to {\n    overflow-y: hidden;\n  }\n}\n@keyframes fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n  to {\n    transform: translateX(0);\n  }\n}\n@media screen and (max-width: 960px) {\n  .customized-timeline .p-timeline-event:nth-child(even) {\n    flex-direction: row !important;\n  }\n  .customized-timeline .p-timeline-event:nth-child(even) .p-timeline-event-content {\n    text-align: left !important;\n  }\n  .customized-timeline .p-timeline-event-opposite {\n    display: none;\n  }\n  .customized-timeline .p-card {\n    margin-top: 1rem;\n  }\n}\n:not(pre) > pre {\n  --tw-bg-opacity: 1;\n  background-color: hsl(74 7% 15% / var(--tw-bg-opacity));\n}\n:is(:where(.dark) :not(pre) > pre) {\n  --tw-bg-opacity: 1;\n  background-color: hsl(60 28% 96% / var(--tw-bg-opacity));\n}\n\npre {\n  --tw-text-opacity: 1;\n  color: hsl(60 28% 96% / var(--tw-text-opacity));\n}\n\n:is(:where(.dark) pre) {\n  --tw-text-opacity: 1;\n  color: hsl(74 7% 15% / var(--tw-text-opacity));\n}\n\npre {\n  padding: 0.3rem;\n  margin: 0.5em 0;\n  border-radius: 0.3em;\n  background: none;\n  font-family: Consolas, Monaco, \"Andale Mono\", \"Ubuntu Mono\", monospace;\n  font-size: 1em;\n  text-align: left;\n  word-spacing: normal;\n  word-break: normal;\n  word-wrap: normal;\n  line-height: 1.5;\n  tab-size: 4;\n  -webkit-hyphens: none;\n  hyphens: none;\n  text-shadow: none;\n}\n\ncode[class*=language-] {\n  font-size: 0.7rem;\n  max-width: calc(100vw - 4rem);\n  display: grid;\n  grid-auto-columns: auto;\n  text-shadow: none;\n  white-space: normal;\n}\n\ncode {\n  --tw-bg-opacity: 1;\n  background-color: hsl(74 7% 15% / var(--tw-bg-opacity));\n}\n\n:is(:where(.dark) code) {\n  --tw-bg-opacity: 1;\n  background-color: hsl(60 28% 96% / var(--tw-bg-opacity));\n}\n\ncode {\n  --tw-text-opacity: 1;\n  color: hsl(60 28% 96% / var(--tw-text-opacity));\n}\n\n:is(:where(.dark) code) {\n  --tw-text-opacity: 1;\n  color: hsl(74 7% 15% / var(--tw-text-opacity));\n}\n\ncode {\n  font-family: ui-monospace, SFMono-Regular, SF Mono, Menlo, Consolas, Liberation Mono, monospace;\n  font-size: 0.7rem;\n  border-radius: 5px;\n  padding: 0.2rem;\n  text-shadow: none;\n}\n\n#container {\n  --tw-bg-opacity: 1;\n  background-color: hsl(0 0% 92% / var(--tw-bg-opacity));\n}\n\n:is(:where(.dark) #container) {\n  --tw-bg-opacity: 1;\n  background-color: hsl(214 18% 15% / var(--tw-bg-opacity));\n}\n\n#container {\n  min-height: 100vh;\n  display: grid;\n  grid-template: 1fr/18rem minmax(18rem, 65rem);\n  justify-content: center;\n}\n#container .welcome {\n  height: 100vh;\n  grid-column: 1/3;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  align-items: center;\n  scroll-snap-align: end;\n}\n#container .welcome__content h1 {\n  font-size: clamp(1rem, 3vw + 1rem, 4rem);\n  position: relative;\n  font-family: \"Source Code Pro\", monospace;\n  width: max-content;\n}\n#container .welcome__content h1::before, #container .welcome__content h1::after {\n  content: \"\";\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n}\n#container .welcome__content h1::before {\n  background: var(--typewriter-bg);\n  animation: typewriter var(--typewriterSpeed) steps(var(--typewriterCharacters)) 1s forwards;\n}\n#container .welcome__content h1::after {\n  width: 0.125em;\n  background: var(--black);\n  animation: typewriter var(--typewriterSpeed) steps(var(--typewriterCharacters)) 1s forwards, blink 750ms steps(var(--typewriterCharacters)) infinite;\n}\n#container .welcome__content__subtitle {\n  color: var(--black);\n  margin: 5rem 0;\n  font-size: 2rem;\n  font-weight: 400;\n  opacity: 0;\n  transform: translateY(3rem);\n  animation: fadeInUp 2s ease calc(var(--typewriterSpeed) + 2s) forwards;\n}\n#container .welcome__content__goto {\n  opacity: 0;\n  animation: bounce 1.5s infinite calc(var(--typewriterSpeed) + 3s), visibility 1.5s forwards calc(var(--typewriterSpeed) + 3s);\n}\n#container .welcome__content__goto:hover {\n  cursor: pointer;\n}\n@keyframes typewriter {\n  to {\n    left: 100%;\n  }\n}\n@keyframes blink {\n  to {\n    background: transparent;\n  }\n}\n@keyframes visibility {\n  to {\n    opacity: 0.8;\n  }\n}\n@keyframes bounce {\n  0%, 20%, 50%, 80%, 100% {\n    transform: translateY(0);\n  }\n  40% {\n    transform: translateY(-30px);\n  }\n  60% {\n    transform: translateY(-15px);\n  }\n}\n@keyframes fadeInUp {\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n#container > aside {\n  padding: 2rem 0;\n  margin: 0 1rem;\n}\n#container > main {\n  scroll-snap-align: start;\n  display: flex;\n  padding: 2rem 1rem;\n}\n#container .scroll-wrapper {\n  width: 100%;\n  height: 0.2rem;\n  position: fixed;\n  inset: 0 0 auto;\n  z-index: 98;\n}\n#container .scroll-wrapper #scroll-tracker {\n  --tw-bg-opacity: 1;\n  background-color: hsl(180 0% 30% / var(--tw-bg-opacity));\n}\n:is(:where(.dark) #container .scroll-wrapper #scroll-tracker) {\n  --tw-bg-opacity: 1;\n  background-color: hsl(210 14% 89% / var(--tw-bg-opacity));\n}\n#container .scroll-wrapper #scroll-tracker {\n  position: fixed;\n  inset: 0 0 auto;\n  height: 0.2rem;\n  width: 0;\n  z-index: 99;\n}\n\n.spinner {\n  animation: progress-spinner-dash 1.5s ease-in-out infinite, progress-spinner-color 6s ease-in-out infinite;\n}\n\n@keyframes progress-spinner-color {\n  100%, 0%, 40%, 66%, 80%, 90% {\n    stroke: hsl(210, 9%, 31%);\n  }\n  :is(:where(.dark) 100%),:is(:where(.dark)  0%),:is(:where(.dark)  40%),:is(:where(.dark)  66%),:is(:where(.dark)  80%),:is(:where(.dark)  90%) {\n    stroke: hsl(240, 4%, 90%);\n  }\n}\n@keyframes progress-spinner-dash {\n  0% {\n    stroke-dasharray: 1, 200;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 89, 200;\n    stroke-dashoffset: -35px;\n  }\n  100% {\n    stroke-dasharray: 89, 200;\n    stroke-dashoffset: -124px;\n  }\n}\n@media print, screen and (max-width: 960px) {\n  #container {\n    grid-template-columns: minmax(18rem, 65rem);\n    padding: 0 1rem;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    encapsulation: 2,
    changeDetection: 0
  });
}
...
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ 804);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 8559);
...
/* harmony import */ var _core_services_config_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @core/services/config.service */ 6792);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ 7420);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ 1480);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ 7714);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ 2058);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 191);
/* harmony import */ var primeng_avatar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! primeng/avatar */ 9499);
/* harmony import */ var primeng_button__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! primeng/button */ 2209);
/* harmony import */ var primeng_card__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! primeng/card */ 198);
/* harmony import */ var primeng_chip__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/chip */ 8564);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/forms */ 9010);
/* harmony import */ var primeng_inputswitch__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! primeng/inputswitch */ 7974);
/* harmony import */ var primeng_ripple__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! primeng/ripple */ 9246);
/* harmony import */ var primeng_tooltip__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! primeng/tooltip */ 8465);
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @shared/shared.module */ 4701);
/* harmony import */ var primeng_menu__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! primeng/menu */ 5862);
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngx-translate/core */ 33);
...
function DetailsComponent_p_dialog_0_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, DetailsComponent_p_dialog_0_ng_template_2_div_1_Template, 2, 0, "div", 8)(2, DetailsComponent_p_dialog_0_ng_template_2_ng_template_2_Template, 3, 2, "ng-template", null, 9, _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplateRefExtractor"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx_r2.loading)("ngIfElse", _r5);
  }
}
const _c0 = () => ({
  maxWidth: "960px"
...
function DetailsComponent_p_dialog_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, DetailsComponent_p_dialog_0_ng_template_1_Template, 5, 2, "ng-template", 2)(2, DetailsComponent_p_dialog_0_ng_template_2_Template, 4, 4, "ng-template", 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    template: function MissionsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](3, MissionsComponent_ng_template_3_Template, 2, 3, "ng-template", 2)(4, MissionsComponent_ng_template_4_Template, 4, 3, "ng-template", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]()();
      }
      if (rf & 2) {
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ 7714);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 2073);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs */ 191);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rxjs/operators */ 4546);
...
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @shared/shared.module */ 4701);
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngx-translate/core */ 33);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ 912);
