...
describe('MissionService', (): void => {
  ...
  it(`should get the path of the full mardown file related to a mission's date`, async (): Promise<void> => {
    const path: string = service.missionFromDate('2019-01-01', 'full');
    expect(path).toEqual(
      'https://raw.githubusercontent.com/gilles-gardet/gilles-gardet.github.io/main/src/assets/resume/missions/en/201901/201901_full.md',
    );
  });
  ...
  it(`should get the path of the light mardown file related to a mission's date`, async (): Promise<void> => {
    const path: string = service.missionFromDate('2019-01-01', 'light');
    expect(path).toEqual(
      'https://raw.githubusercontent.com/gilles-gardet/gilles-gardet.github.io/main/src/assets/resume/missions/en/201901/201901_light.md',
    );
  });
  ...
  it(`should fetch the list of missions`, async (): Promise<void> => {
    ...
    const missionsRequest: TestRequest = httpTestingController.expectOne(
      'https://raw.githubusercontent.com/gilles-gardet/gilles-gardet.github.io/main/src/assets/resume/missions.json',
    );
    ...
    const descriptionRequest: TestRequest = httpTestingController.expectOne(
      'https://raw.githubusercontent.com/gilles-gardet/gilles-gardet.github.io/main/src/assets/resume/missions/en/202007/202007_light.md',
    );
